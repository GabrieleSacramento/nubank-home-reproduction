...
import 'package:nubank_home_reproduction/core/extensions/theme_extension.dart';
import 'package:nubank_home_reproduction/src/atoms/assets/nubank_icons.dart';
import '../../../../shared/widgets/base_bottom_sheet.dart';
import '../../../my_cards/presentation/widgets/my_cards_widget.dart';
import '../../cubits/get_balance_cubit.dart';
import '../../cubits/get_discover_more_list_cubit.dart';
import '../../../my_cards/presentation/widgets/balance_shimmer.dart';
...
final _themeCubit = setup.get<NubankThemeCubit>();
...
class _NubankHomePageState extends State<NubankHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return MultiBlocProvider(
      ...
      child: BlocBuilder<NubankThemeCubit, NubankThemeState>(
            ...
            body: SingleChildScrollView(
              child: Column(
                children: [
                        ...
                        return _NuBalanceWidget(
                          balance: isBalanceVisible.value
                              ...
                              : NubankText(
                                  '....',
                                  textStyle:
                                      NubankFontStyle.bodyLargerStandard(),
                                ),
                        );
                      }
                  ...
                  BlocBuilder<GetDiscoverMoreListCubit,
                      GetDiscoverMoreListState>(
                    builder: (context, state) {
      ...
      child: Align(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: context.nuTheme.cardTheme.nuWhite,
          ...
          child: Align(
            ...
            child: ColorFiltered(
              colorFilter: ColorFilter.mode(
                  context.nuTheme.iconTheme.nuBlack, BlendMode.srcIn),
    ...
    return CarouselSlider(
      items: [
        _NuFinancialServicesWidget(
          text: Text(
            'Seu informe de rendimentos 2021 já está disponível',
            style: TextStyle(
              color: context.nuTheme.textTheme.nuBlack,
        ...
        child: Row(
          children: [
            Padding(
              ...
              child: ColorFiltered(
                colorFilter: ColorFilter.mode(
                  context.nuTheme.iconTheme.nuBlack,
                  BlendMode.srcIn,
                ),
                child: SvgPicture.asset(
                  NubankIcons.card,
          ...
          bottom: PreferredSize(
            ...
            child: Padding(
              ...
              child: Align(
                alignment: Alignment.topLeft,
                child: Text(
                  '${strings.hello}, Gabriele Sacramento',
                  style: TextStyle(
                    fontSize: NubankSpacing.sp18,
                    fontWeight: FontWeight.w700,
                    color: NubankColors.nuWhite,
                  ),
                ),
